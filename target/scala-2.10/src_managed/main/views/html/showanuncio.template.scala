        ...
        <div class="insideBox">
          ...
          <p><span style="font-size:12px;">"""),_display_(Seq[Any](/*67.45*/anuncio/*67.52*/.getDescricao)),format.raw/*67.65*/("""</span>
           <p><span style="font-size:12px;"><b>Instrumentos: </b>"""),_display_(Seq[Any](/*68.67*/anuncio/*68.74*/.getInstrumentos)),format.raw/*68.90*/("""</span>
            ...
            """),_display_(Seq[Any](/*75.14*/helper/*75.20*/.form(action=routes.Application.deletarAnuncio(anuncio.getId))/*75.82*/ {_display_(Seq[Any](format.raw/*75.84*/("""
            <div class="row">

                 <div  id="idDelete" "four columns">
                                    
                    <input id="codigo" class="u-full-width" type="text" placeholder="" name="idDelete" value="">
                    ...
                    <script>
                        $( "#codigo" ).hide();
                        function finalizarAnuncio()"""),format.raw/*89.52*/("""{"""),format.raw/*89.53*/("""
                            
                            var id = prompt("Digite o id do anúncio");

                            if (id != null) """),format.raw/*93.45*/("""{"""),format.raw/*93.46*/("""
                                $( "#codigo" ).value = id;
                                $( "#buttonFinalize" ).hide();
                                $( "#idDelete" ).append('<input class="button-primary" type="submit" value="Deletar anúncio" id="delAnuncio">');
